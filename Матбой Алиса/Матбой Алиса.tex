...
\usepackage[left=1.6cm,right=1.9cm,top=1.8cm,bottom=1.5cm]{geometry}
...
\fancyhead[C]{}
\fancyhead[R]{11.07.2023}% Custom header text
...
\begin{center}
	\begin{figure}[h]
		...
		\begin{minipage}[h]{0.1\linewidth}
			\center{\includegraphics[width=1\linewidth]{img4.png}}
		\end{minipage}
		\begin{minipage}[h]{0.1\linewidth}
			\center{\includegraphics[width=1\linewidth]{img.png}}
		\end{minipage}
		\begin{minipage}[h]{0.1\linewidth}
			\center{\includegraphics[width=1\linewidth]{img3.png}}
		\end{minipage}
